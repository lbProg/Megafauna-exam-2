...
mcmc_p.sex_phi.timeCAT.oxyCAT_D8FD9M_additive$summary
```
...
mcmc_p.sex_phi.timeCAT.oxyCAT_D9FD8M_additive$summary
```
...
| 1 | continuous | **531** |
| 2 | categorical | **532** |
| 3 | categorical (9 first deciles pulled) | **530** |
| 4 | categorical (8 first deciles pulled) | **531** |
| 5 | categorical x sex | 537 |
| 6 | categorical (9 first deciles pulled for males and 8 first deciles pulled for females) x sex | **531** |
| 7 | categorical (9 first deciles pulled for males and 8 first deciles pulled for females) | **530** |
| 8 | categorical (8 first deciles pulled for males and 9 first deciles pulled for females) | **530** |
